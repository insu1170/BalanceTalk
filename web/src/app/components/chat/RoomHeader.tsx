...
export default function RoomHeader({ roomId, title = "밸런스 토론방", participants, className }: RoomHeaderProps) {
    return (
        <header className={`sticky top-0 z-10 border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 ${className ?? ""}`}>
            <div className="mx-auto max-w-4xl px-4 py-3 flex items-center gap-3">
                <Link href="/" className="rounded-xl border px-3 py-1 text-sm hover:bg-gray-50">← 목록</Link>
